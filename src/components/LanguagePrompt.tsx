      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="grain fixed inset-x-4 top-1/2 z-[105] mx-auto max-w-md -translate-y-1/2 overflow-hidden rounded-[2rem] bg-ink-900 px-6 py-9 text-center shadow-[0_60px_120px_-40px_rgba(27,23,18,0.7)] sm:inset-x-auto sm:px-10"
          >
